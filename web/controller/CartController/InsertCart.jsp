...
<%
    ...
    response.sendRedirect("/web-project-lab/web/controller/ProductController/StockUpdate.jsp?product_id=" + product_id + "&quantity=" + quantity + "&quantity_temp=" + quantity_temp + "&text=" + text);
%>
