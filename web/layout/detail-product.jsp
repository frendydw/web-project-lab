...
<body>
	<% 
        ...
        if (product_id > 0) {
			...
			src = "/web-project-lab/web/images/" + product.getImagePath();
        }
                ...
                <div id="login-column" class="col-md-11">
                    <div id="login-box" class="col-md-12">
                        <form id="login-form" class="form" action="../controller/CartController/InsertCart.jsp" method="post">
                            ...
                            <a class="text-info" href="/web-project-lab/web/layout/view-cart.jsp">Show my cart</a>
     ...
     <div id="login">
        <div class="container mb-5">
            <div id="login-row" class="row justify-content-center align-items-center">
                <div id="login-column" class="col-md-11">
                    <div id="login-box" class="col-md-12">
                        <form name="detailProductForm" id="login-form" class="form" action="/web-project-lab/web/controller/CartController/UpdateReviewCart.jsp" method="post" onsubmit = "return validateForm()">
